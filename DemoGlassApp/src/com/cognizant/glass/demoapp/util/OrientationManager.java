...
public class OrientationManager {
    ...
    public OrientationManager(Context cxt) {
    	  SensorManager sensorManager =
	                (SensorManager) cxt.getSystemService(Context.SENSOR_SERVICE);
	        LocationManager locationManager =
	                (LocationManager) cxt.getSystemService(Context.LOCATION_SERVICE);
